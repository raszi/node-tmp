 ...
 * Tmp
 *
 * Copyright (c) 2011-2014 KARASZI Istvan <github@spam.raszi.hu>
 *
 * MIT Licensed
 */
 ...
 * @param {String} chars the characters we choose from
 * @return {String}
 * @api private
 */
function _random(howMany, chars) {
  var
    value = [],
    len = chars.length;
    rnd = null;
...
function _getTmpName(options, callback) {
  ...
  function _getName() {
    ...
    return template.replace(/XXXXXX/, _random(6, randomChars));
  }
